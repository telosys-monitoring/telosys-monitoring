...
public class LongestRequestsCopyTest {
	
	@Test
	public void testResizePlus1() {
		LongestRequests longestRequests = new LongestRequests(3);
		LongestRequests longestRequests2 = new LongestRequests(longestRequests, 4);
		List<Request> requests = longestRequests2.getAllDescending();
		...
		longestRequests2 = new LongestRequests(longestRequests, 4);
		requests = longestRequests2.getAllDescending();
	...
	public void testResizeMoins1() {
		LongestRequests longestRequests = new LongestRequests(3);
		LongestRequests longestRequests2 = new LongestRequests(longestRequests, 2);
		List<Request> requests = longestRequests2.getAllDescending();
		assertEquals(0, requests.size());
		...
		r1.setRequestURL("url1");
		longestRequests.add(r1);
		longestRequests2 = new LongestRequests(longestRequests, 2);
		requests = longestRequests2.getAllDescending();
		assertEquals(1, requests.size());
		assertEquals(r1, requests.get(0));
